    ...
    <>
      <Row className="home cobertura">
        ...
        <Row className="d-flex justify-content-between">
          <Col lg={1} className="medios-cobertura-container">
            <div className="iconos" src="./antena.png" id="antena" alt="" />
            <p className="titulo-iconos ">Radio y TV</p>
            <p className="texto-iconos">Max Maxima 95.5 <br/>FM Tostado Cable</p>
          </Col>
          <Col lg={1} className="medios-cobertura-container">
